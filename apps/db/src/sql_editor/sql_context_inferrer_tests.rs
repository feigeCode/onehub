        ...
        "[a-z][a-z0-9_]{0,10}".prop_filter("not a keyword", |s| {
            !matches!(
                ...
                "SELECT" | "FROM" | "WHERE" | "JOIN" | "AND" | "OR" | "ON"
                    ...
                    | "HAVING" | "LIMIT" | "DISTINCT" | "ALL" | "IS" | "IN"
                    | "NOT" | "NULL" | "LIKE" | "BETWEEN" | "EXISTS" | "CASE"
                    | "WHEN" | "THEN" | "ELSE" | "END" | "WITH" | "ASC" | "DESC"
                    | "UNION" | "INTERSECT" | "EXCEPT" | "PRIMARY" | "FOREIGN"
                    | "KEY" | "REFERENCES" | "UNIQUE" | "CHECK" | "DEFAULT"
                    | "TRUNCATE" | "USING" | "INDEX" | "VIEW" | "ALTER" | "DROP"
            )
        })
    }
