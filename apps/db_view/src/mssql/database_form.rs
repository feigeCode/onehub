...
impl MsSqlDatabaseForm {
    pub fn new(window: &mut Window, cx: &mut Context<Self>) -> Self {
        ...
        let collation_items = vec![
            CollationSelectItem::new("SQL_Latin1_General_CP1_CI_AS", "Latin1 General, case-insensitive (默认)"),
            CollationSelectItem::new("SQL_Latin1_General_CP1_CS_AS", "Latin1 General, case-sensitive"),
            ...
            CollationSelectItem::new("Latin1_General_CS_AS", "Latin1 General (Windows), case-sensitive"),
            CollationSelectItem::new("Latin1_General_100_CI_AS_SC", "Latin1 General 100 (Unicode)"),
        ];
